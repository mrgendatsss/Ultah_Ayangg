...
export default function GiftPart2Page() {
      ...
      >
        {!opened ? (
          <>
            ...
            <h1 className="text-3xl font-serif text-gold mb-2 text-center">Second Gift Unlocked</h1>
            <p className="text-white/60 text-center mb-12">You found the second QR code! Tap the box to reveal your next present.</p>
          ...
          >
            ...
            <h2 className="text-2xl font-serif text-gold mb-4">A Trip to Bali</h2>
            <p className="text-white/80 mb-8 leading-relaxed">
              Pack your bags, baby! We're flying out next month for a romantic getaway. Just you, me, and the beautiful beaches.
            </p>
            
            <p className="text-white/50 text-sm mb-8 italic">
              Check your email for the flight itinerary.
            </p>
            ...
            >
              Find the Final Gift <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        )}
      </motion.div>
